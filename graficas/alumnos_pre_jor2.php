...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'ALUMNOS PREGISTRADOS POR TALLERE JORNADA 2'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
              ...
              $consulta = "SELECT jornada2.taller,jornada2_alumnos.taller_2, count(*) AS Inscritos FROM jornada2,jornada2_alumnos WHERE jornada2.taller=jornada2_alumnos.taller_2 GROUP BY taller";
